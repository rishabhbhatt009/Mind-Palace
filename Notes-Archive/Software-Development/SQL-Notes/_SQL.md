...
[faq](faq.md) | [leetcode-sql](leetcode-sql.md) | [pivoting-tables](pivoting-tables.md) | [window-functions](window-functions.md)
...
## Resources : 
- [SQL-Basics.pdf](sql-basics-cheat-sheet-a4.pdf)
- [SQL-Joins.pdf](joins-cheat-sheet-a4.pdf)
- [SQL-Window-Functions.pdf](Window_Functions_Cheat_Sheet.pdf)
...
![image](sql-join-chart-custom-poster-size-sql.png)
